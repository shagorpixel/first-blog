    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mb-4">
            <div class="entry2">
              <a href="{{route('postpage',$post->slug)}}"><img style="height: 240px; width:360px;" src="{{asset('website/images/posts/'.$post->image)}}" alt="Image" class="img-fluid rounded"></a>
              <div class="excerpt">
              <span class="post-category text-white bg-secondary mb-3">{{$post->category->name}}</span>

              <h2><a href="{{route('postpage',$post->slug)}}">{{$post->title}}</a></h2>
              <div class="post-meta align-items-center text-left clearfix">
                <figure class="author-figure mb-0 mr-3 float-left"><img src="{{asset('backend/img/user/'.$post->user->image)}}" alt="Image" class="img-fluid"></figure>
