...
@section('content')
    <div class="site-cover site-cover-sm same-height overlay single-page"
        style="background-image: url({{ asset('website/images/posts/' . $post->image) }});">
        <div class="container">
            <div class="row same-height justify-content-center">
                <div class="col-md-12 col-lg-10">
                    <div class="post-entry text-center">
                        <span class="post-category text-white bg-success mb-3">{{ $post->category->name }}</span>
                        <h1 class="mb-4"><a href="{{ route('postpage', $post->slug) }}">{{ $post->title }}</a></h1>
                        <div class="post-meta align-items-center text-center">
                            <figure class="author-figure mb-0 mr-3 d-inline-block"><img
                                    src="{{ asset('backend/img/user/' . $post->user->image) }}" alt="Image"
                    ...
                    <div class="pt-5">
                        <p>Categories: <a href="#">{{ $post->category->name }}</a> Tags:
                            @foreach ($post->tags as $tag)
                                <a href="{{route('tagpage',$tag->slug)}}">{{ $tag->name }}</a>
                            @endforeach
                        </p>
                    </div>
                ...
                <div class="col-md-12 col-lg-4 sidebar">
                    ...
                    <div class="sidebar-box">
                        <div class="bio text-center">
                            <img src="{{ asset('backend/img/user/' . $post->user->image) }}" alt="Image Placeholder"
                                ...
                                @foreach ($posts as $post)
                                    <li>
                                        <a href="{{route('postpage',$post->slug)}}">
                                            <img src="{{asset('website/images/posts/'.$post->image)}}" alt="Image placeholder"
                                                class="mr-4">
                                            <div class="text">
                                                <h4>{{$post->title}}</h4>
                                                <div class="post-meta">
                    ...
                    <div class="sidebar-box">
                        ...
                        <ul class="categories">
                            @foreach ($categories as $category)
                                <li><a href="{{route('categorypage',$category->slug)}}">{{ $category->name }} <span>({{$category->posts->count()}})</span></a></li>
                            @endforeach
                        </ul>
                        ...
                        <div class="sidebar-box mt-5">
                            ...
                            <ul class="tags">
                                @foreach ($tags as $tag)
                                    <li><a href="{{ route('tagpage',$tag->name) }}">{{ $tag->name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
